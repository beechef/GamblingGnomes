...
namespace Game.Runtime.GameMode.Poker.BetItems
{
	...
	// before, which is the whole reason the winner's choice of what to bet is worth making: feeding
	...
	// ignore it entirely.
	[CreateAssetMenu(fileName = "BetItemEffect_Hallucination", menuName = "Game/Poker/Bet Item Effects/Hallucination")]
	public class PokerBetItemHallucinationEffect : PokerBetItemEffect
	{
		...
		protected override int OnPreviewHallucinationGain(PokerGameMode gameMode, PokerPlayer eater, PokerBetItemType itemType)
		{
			var consume = eater.BetItemConsume;

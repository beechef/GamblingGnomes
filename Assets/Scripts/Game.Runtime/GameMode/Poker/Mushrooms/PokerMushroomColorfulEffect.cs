...
namespace Game.Runtime.GameMode.Poker.Mushrooms
{
	...
	[CreateAssetMenu(fileName = "MushroomEffect_Colorful", menuName = "Game/Poker/Mushroom Effects/Colorful")]
	public class PokerMushroomColorfulEffect : PokerMushroomEffect
	{

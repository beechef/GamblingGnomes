...
namespace Game.Runtime.GameMode.Poker.Items
{
	...
	{
		public void ConsumeServer(PokerGameMode gameMode, PokerPlayer eater, PokerItemType itemType)
		{
		...
		public int PreviewHallucinationGain(PokerGameMode gameMode, PokerPlayer eater, PokerItemType itemType)
		{
		...
		protected abstract void OnConsumeServer(PokerGameMode gameMode, PokerPlayer eater, PokerItemType itemType);

		// Zero for a kind that costs no hallucination at all, which is the honest answer for most of them.
		protected virtual int OnPreviewHallucinationGain(PokerGameMode gameMode, PokerPlayer eater, PokerItemType itemType) => 0;
	}
}
